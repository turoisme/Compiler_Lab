...
Object* checkDeclaredConstant(char* name) {
  // Check if the identifier is a declared constant
  Object* obj = lookupObject(name);
  if (obj == NULL) {
...
Object* checkDeclaredType(char* name) {
  // Check if the identifier is a declared type
  Object* obj = lookupObject(name);
  if (obj == NULL) {
...
Object* checkDeclaredVariable(char* name) {
  // Check if the identifier is a declared variable
  Object* obj = lookupObject(name);
  if (obj == NULL) {
...
Object* checkDeclaredFunction(char* name) {
  // Check if the identifier is a declared function
  Object* obj = lookupObject(name);
  if (obj == NULL) {
